...
- relational databases are a collection of data that is formated into rows and columns. SQL is a query language and method in which we interact with said data.

2. Why do tables need a `primary key`?

- Tables need a primary key to function as a unique indentifier to make sure no 2 rows match. This helps resist data corruption.
...
- and intermediary table to hold the foreign keys that reference primary keys on different tables.
